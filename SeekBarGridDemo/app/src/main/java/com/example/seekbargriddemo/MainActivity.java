package com.example.seekbargriddemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    SeekBar seekMusic;
    RatingBar rate;
    int imgArr[]={R.mipmap.i1,R.mipmap.cat,R.mipmap.i3,R.mipmap.i4};
    int i=0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seekMusic.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                Toast.makeText(MainActivity.this, String.format("%d", i), Toast.LENGTH_SHORT).show();
//                .makeText(MainActivity.this, ""+i, Toast.LENGTH_SHORT).show();
            }
